...
describe('TaskFilterStore', () => {
  ...
  it('should correctly filter tasks', () => {
    ...
    const tasks: Task[] = [
      { id: 1, title: 'Low Task', completed: false, priority: TaskPriority.Low },
      { id: 2, title: 'Medium Task', completed: true, priority: TaskPriority.Medium },
      { id: 3, title: 'High Task', completed: false, priority: TaskPriority.High }
    ];
